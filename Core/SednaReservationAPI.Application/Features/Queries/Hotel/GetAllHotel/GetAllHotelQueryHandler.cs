...
namespace SednaReservationAPI.Application.Features.Queries.Hotel.GetAllHotel
{
    ...
    {
        Task<GetAllHotelQueryResponse> IRequestHandler<GetAllHotelQueryRequest, GetAllHotelQueryResponse>.Handle(GetAllHotelQueryRequest request, CancellationToken cancellationToken)
        {
